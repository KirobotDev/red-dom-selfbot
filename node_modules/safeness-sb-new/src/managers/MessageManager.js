...
async edit(message, options) {
  ...
  if (files && files.size > 0) {
    // Nouvel API - seulement si des fichiers sont présents
    ...
    // Si pas de fichiers, ne pas inclure le champ attachments
    // Ou le définir comme tableau vide selon ce que Discord attend
    // La plupart du temps, il vaut mieux ne pas l'inclure du tout
